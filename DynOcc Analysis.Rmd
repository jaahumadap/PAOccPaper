...
plot(1:5, obs, type="p",ylim=c(0,1),xlab="time",ylab="occupancy"); lines(1:5, mod); lines(1:5, mods, lty=2)
```
...
```{r, cache = TRUE}
# Run a simulation
test <- simulatetrend(points = 60, psi = 0.2, gamma = 0.05, phi = 0.9, nsim = 100, years = 15)
```
